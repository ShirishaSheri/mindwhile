...
import servicestyles from './Hiredevs.css';
...
const Hireux = () => {
 ...
 <section class="php-section relative top-[6vw]">
    <div class="php-content">
      <h1>Hire <span class="highlight">UI/UX </span> Developers</h1>
     
     <p>
Discover astonishing and user-friendly designs at IMG Global Infotech. Our UI/UX design services deliver engaging,
 intuitive interfaces for maximum customer satisfaction. Whether you are developing a mobile app, website, or custom software, our UI/UX designers focus on user experience and business goals,
 making your digital product stand out and perform seamlessly      </p>
