...
<section class="php-section relative top-[6vw]">
    <div class="php-content ">
      <h1>Hire <span class="highlight">PHP</span> Developers</h1>
      <h3>Mindwhile Infotech has gracefully proved its worth as the finest IT service</h3>
      <p>
        Mindwhile Infotech has gracefully proved its worth as the finest IT service provider, mobile app & web development company for over a decade.
